...
class ShelfPlaneAnnotator : public DrawingAnnotator
{
private:
  enum
  {
...
public:
  ShelfPlaneAnnotator() : DrawingAnnotator(__func__), mode(BOARD), display(new pcl::PointCloud<pcl::PointXYZRGBA>()),
